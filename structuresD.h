/* "structures.h" defines the look-up tables and KeyExpansionD function 
...
// Used in KeyExpansionD
unsigned char rconD[256] = {
...
// Auxiliary function for KeyExpansionD
void KeyExpansionCoreD(unsigned char * in, unsigned char i) {
...
/* The main KeyExpansionD function
 ...
 */
void KeyExpansionD(unsigned char inputKey[16], unsigned char expandedKeys[176]) {
	...
	while (bytesGenerated < 176) {
		...
		*/
		...
		if (bytesGenerated % 16 == 0) {
			KeyExpansionCoreD(tmpCore, rconIteration++);
		}
